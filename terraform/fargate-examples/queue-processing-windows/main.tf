...
locals {
  ...
  name   = "windows-ecsdemo-queue-proc"
  region = "eu-west-1"

  container_name = "windows-ecsdemo-queue-proc"
...
module "lambda_function" {
  ...
  source_path        = "../../../application-code/lambda-function-queue-trigger-windows/"
...
resource "aws_ssm_parameter" "ecs_pipeline_max_tasks" {
  name  = "WIN_PIPELINE_ECS_MAX_TASKS"
  type  = "String"
  value = 100
...
resource "aws_ssm_parameter" "sqs_processing_queue" {
  name  = "WIN_PIPELINE_UNPROCESSED_SQS_URL"
  type  = "String"
...
resource "aws_ssm_parameter" "s3_destination_bucket" {
  name  = "WIN_PIPELINE_S3_DEST_BUCKET"
  type  = "String"
...
resource "aws_ssm_parameter" "ecs_task_definition" {
  name  = "WIN_PIPELINE_ECS_TASK_DEFINITON"
  type  = "String"
...
resource "aws_ssm_parameter" "ecs_task_container_name" {
  name  = "WIN_PIPELINE_ECS_TASK_CONTAINER"
  type  = "String"
...
resource "aws_ssm_parameter" "ecs_task_subnet" {
  name  = "WIN_PIPELINE_ECS_TASK_SUBNET"
  type  = "String"
...
resource "aws_ssm_parameter" "ecs_task_security_group" {
  name  = "WIN_PIPELINE_ECS_TASK_SECURITYGROUP"
  type  = "String"
